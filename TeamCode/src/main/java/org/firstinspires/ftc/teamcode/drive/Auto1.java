...
public class Auto1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(14, 57, Math.toRadians(270));
        ...
        while(opModeIsActive() && !isStopRequested()){
            ...
            TrajectorySequence trajSeqCaz2 = drive.trajectorySequenceBuilder(startPose)
                    .lineToSplineHeading(new Pose2d(15, 26, Math.toRadians(270)))
                    .back(8)
                    .build();
            TrajectorySequence trajSeqCaz3 = drive.trajectorySequenceBuilder(startPose)
                    .lineToSplineHeading(new Pose2d(5, 31, Math.toRadians(220)))
                    .back(5)
                    .build();
            if(element_zone==1)
            {
